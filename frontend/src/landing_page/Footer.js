    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logooo.jpg" style={{ width: "60%" }} alt=""/>
            <p>
          ...
          <div className="col">
            ...
            <br />
            <a href="?" style={{textDecoration:"none"}}className="text-muted">Finovue.tech</a>
            <br />
            <a href="?" style={{textDecoration:"none"}}className="text-muted">Press & media</a>
            <br />
            <a href="?" style={{textDecoration:"none"}} className="text-muted">Finovue cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            Finovue Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Finovue Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Finovue Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Finovue Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@Finovue.com, for DP related to dp@Finovue.com. Please
          ...
          <p>
            ...
            claiming to be part of Finovue and offering such services, please
